...
router.get('/delete-image/:image', (req, res) => {
  const originalImage = 'public/product-images/' + req.query.id + '/gallery/' + req.params.image;
  const thumbImage = 'public/product-images/' + req.query.id + '/gallery/thumbs/' + req.params.image;
